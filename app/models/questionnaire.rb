class Questionnaire < ApplicationRecord
  ...
  validates_format_of :vcs_url, with: %r{\A((https?:\/\/)?(www\.)?github\.com\/\w+\/?)|((https?:\/\/)?(www\.)?gitlab\.com\/\w+\/?)|((https?:\/\/)?(www\.)?bitbucket\.org\/\w+\/?)\z}i, allow_blank: true, message: "Must be a GitHub, GitLab or Bitbucket url"
  strip_attributes
