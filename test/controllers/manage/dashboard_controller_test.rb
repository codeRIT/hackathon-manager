...
class Manage::DashboardControllerTest < ActionController::TestCase
  ...
  context "while authenticated as an admin" do
    ...
    should "allow access to all data endpoints" do
      ...
      stub_request(:get, "https://geocoding.geo.census.gov/geocoder/locations/address?street=123+Fake+Street&city=Rochester&state=New+York&benchmark=Public_AR_Current&format=json").
