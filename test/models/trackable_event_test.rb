...
class TrackableEventTest < ActiveSupport::TestCase
  ...
  should "allow duplicate band IDs when tag#allow_duplicate_band_events is false" do
  ...
  should "not allow duplicate band IDs when tag#allow_duplicate_band_events is true" do
  ...
  should "allow same band ID for multiple tags when tag#allow_duplicate_band_events is true" do
    trackable_tag1 = create(:trackable_tag, allow_duplicate_band_events: true)
    trackable_tag2 = create(:trackable_tag, allow_duplicate_band_events: true)
