...
class QuestionnaireTest < ActiveSupport::TestCase
  ...
  should allow_value('github.com/foo', 'gitlab.com/bar', 'bitbucket.org/sman591').for(:vcs_url)
  should allow_value('https://github.com/foo', 'https://gitlab.com/bar', 'https://bitbucket.org/sman591').for(:vcs_url)
